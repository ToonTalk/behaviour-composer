...
ALTER TABLE `behaviour_composer_schema2`.`event_add_micro_behaviour` ADD COLUMN `name_if_macro_behaviour` MEDIUMTEXT NULL DEFAULT NULL  AFTER `insertion_index` , CHANGE COLUMN `session_guid` `session_guid` CHAR(22) ASCII NOT NULL COMMENT 'The read-write session GUID.'  ;

ALTER TABLE `behaviour_composer_schema2`.`event_remove_micro_behaviour` ADD COLUMN `name_if_macro_behaviour` MEDIUMTEXT NULL DEFAULT NULL  AFTER `containing_url` , CHANGE COLUMN `session_guid` `session_guid` CHAR(22) ASCII NOT NULL COMMENT 'The read-write session GUID.'  ;
...
ALTER TABLE `behaviour_composer_schema2`.`event_activate_micro_behaviour` ADD COLUMN `name_if_macro_behaviour` MEDIUMTEXT NULL DEFAULT NULL  AFTER `containing_url` , CHANGE COLUMN `session_guid` `session_guid` CHAR(22) ASCII NOT NULL COMMENT 'The read-write session GUID.'  ;

ALTER TABLE `behaviour_composer_schema2`.`event_inactivate_micro_behaviour` ADD COLUMN `name_if_macro_behaviour` MEDIUMTEXT NULL DEFAULT NULL  AFTER `containing_url` , CHANGE COLUMN `session_guid` `session_guid` CHAR(22) ASCII NOT NULL COMMENT 'The read-write session GUID.'  ;
...
ALTER TABLE `behaviour_composer_schema2`.`event_move_micro_behaviour` ADD COLUMN `name_if_macro_behaviour` MEDIUMTEXT NULL DEFAULT NULL  AFTER `containing_url` ;
