...
ALTER TABLE `behaviour_composer_schema2`.`event_add_micro_behaviour` ADD COLUMN `insertion_index` INT(11) NOT NULL DEFAULT 9999999  AFTER `containing_url` , CHANGE COLUMN `session_guid` `session_guid` CHAR(22) ASCII NOT NULL COMMENT 'The read-write session GUID.'  ;
