...
ALTER TABLE `behaviour_composer_schema2`.`event_add_micro_behaviour` ADD COLUMN `containing_url` VARCHAR(2087) NULL DEFAULT NULL  AFTER `text_area_updates_id` , CHANGE COLUMN `session_guid` `session_guid` CHAR(22) ASCII NOT NULL COMMENT 'The read-write session GUID.'  ;

ALTER TABLE `behaviour_composer_schema2`.`event_remove_micro_behaviour` ADD COLUMN `containing_url` VARCHAR(2087) NULL DEFAULT NULL  AFTER `text_area_updates_id` , CHANGE COLUMN `session_guid` `session_guid` CHAR(22) ASCII NOT NULL COMMENT 'The read-write session GUID.'  ;
...
ALTER TABLE `behaviour_composer_schema2`.`event_activate_micro_behaviour` ADD COLUMN `containing_url` VARCHAR(2087) NULL DEFAULT NULL  AFTER `text_area_updates_id` , CHANGE COLUMN `session_guid` `session_guid` CHAR(22) ASCII NOT NULL COMMENT 'The read-write session GUID.'  ;

ALTER TABLE `behaviour_composer_schema2`.`event_inactivate_micro_behaviour` ADD COLUMN `containing_url` VARCHAR(2087) NULL DEFAULT NULL  AFTER `text_area_updates_id` , CHANGE COLUMN `session_guid` `session_guid` CHAR(22) ASCII NOT NULL COMMENT 'The read-write session GUID.'  ;
...
ALTER TABLE `behaviour_composer_schema2`.`event_edit_micro_behaviour` ADD COLUMN `containing_url` VARCHAR(2087) NULL DEFAULT NULL  AFTER `user_id` , CHANGE COLUMN `session_guid` `session_guid` CHAR(22) ASCII NOT NULL  ;
...
ALTER TABLE `behaviour_composer_schema2`.`event_rename_micro_behaviour` ADD COLUMN `containing_url` VARCHAR(2087) NULL DEFAULT NULL  AFTER `user_id` , CHANGE COLUMN `session_guid` `session_guid` CHAR(22) ASCII NOT NULL  ;
