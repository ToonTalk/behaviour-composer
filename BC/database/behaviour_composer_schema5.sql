...
-- -----------------------------------------------------
-- Table `behaviour_composer_schema2`.`micro_behaviour_copy_micro_behaviours`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `behaviour_composer_schema2`.`micro_behaviour_copy_micro_behaviours` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `behaviour_composer_schema2`.`micro_behaviour_copy_micro_behaviours` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `guid` CHAR(22) ASCII NOT NULL ,
  `list_name` MEDIUMTEXT NOT NULL ,
  `micro_behaviour_urls` MEDIUMTEXT NOT NULL ,
  INDEX `guid` (`guid` ASC) ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB;
