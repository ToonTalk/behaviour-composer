...
-- -----------------------------------------------------
-- Table `behaviour_composer_schema2`.`event_toggle_include_macro_behaviour`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `behaviour_composer_schema2`.`event_toggle_include_macro_behaviour` ;

CREATE  TABLE IF NOT EXISTS `behaviour_composer_schema2`.`event_toggle_include_macro_behaviour` (
  `add_to_model` BOOLEAN NOT NULL ,
  `id` INT NOT NULL AUTO_INCREMENT ,
  `session_guid` CHAR(22) ASCII NOT NULL COMMENT 'The read-write session GUID.' ,
  `time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,
  `macro_behaviour_name_at_event_time` MEDIUMTEXT NOT NULL COMMENT 'Name of the macro-behaviour at the time of the event.' ,
...
-- -----------------------------------------------------
-- Table `behaviour_composer_schema2`.`event_add_to_model_list_box_macro_behaviour`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `behaviour_composer_schema2`.`event_add_to_model_list_box_macro_behaviour` ;
...
-- -----------------------------------------------------
-- Table `behaviour_composer_schema2`.`event_session_events_check_box_toggled`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `behaviour_composer_schema2`.`event_session_events_check_box_toggled` ;

CREATE  TABLE IF NOT EXISTS `behaviour_composer_schema2`.`event_session_events_check_box_toggled` (
  `value_at_event_time` BOOLEAN NOT NULL ,
  `check_box_session_guid` VARCHAR(22) NOT NULL ,
  `id` INT NOT NULL AUTO_INCREMENT ,
  `session_guid` VARCHAR(22) NOT NULL ,
  `user_id` INT NOT NULL ,
  `time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,
  `name_id` TEXT NOT NULL ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB
COMMENT = 'Check boxes toggle';


-- -----------------------------------------------------
-- Table `behaviour_composer_schema2`.`egm_serial_number`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `behaviour_composer_schema2`.`egm_serial_number` ;
